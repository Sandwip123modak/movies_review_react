...
const Header = () => {
  ...
  return (
    <div className='sticky top-0 header text-3xl flex justify-between items-center text-red-500 font-bold p-3 border-b-2 border-gray-500'>
       <Link to='/'><span>Filmy<span className='text-white'>Versa</span></span></Link><h2 className='text-green-300'>MOVIE FANTASY! KNOW ABOUT YOUR FAVOURITE MOVIE</h2>
        {
          useAppstate.login ?
          <Link to={'/addmovie'}>
